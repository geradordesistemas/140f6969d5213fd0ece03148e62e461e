...
#[ACL\Admin(enable: true, title: 'Realizacao', description: 'Permissões modulo Realizacao')]
class RealizacaoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Realizacao')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Realizacao')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Realizacao')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Realizacao')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Realizacao')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Realizacao em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Realizacao')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Realizacao')]
