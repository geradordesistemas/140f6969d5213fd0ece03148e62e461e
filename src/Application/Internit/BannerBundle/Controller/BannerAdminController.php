...
namespace App\Application\Internit\BannerBundle\Controller;
...
#[ACL\Admin(enable: true, title: 'Banner', description: 'Permissões modulo Banner')]
class BannerAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Banner')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Banner')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Banner')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Banner')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Banner')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Banner em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Banner')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Banner')]
