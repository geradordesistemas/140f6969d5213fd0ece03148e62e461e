...
#[Route('/api/banner', name: 'api_banner_')]
#[OA\Tag(name: 'Banner')]
#[ACL\Api(enable: true, title: 'Banner', description: 'Permissões do modulo Banner')]
class BannerApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — Banner.
     * Recupera a coleção de recursos — Banner.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos Banner',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar Banner')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — Banner.
     * Cria o Recurso — Banner.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso Banner',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
            ],
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar Banner')]
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Banner')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'Banner não encontrado!'], 404);
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Banner')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Banner')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Banner removido com sucesso.'], 204);
    }
