...
use App\Application\Internit\BannerBundle\Form\BannerType;
...
#[Route('/web/banner', name: 'web_banner_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Banner', description: 'Permissões do modulo Banner')]
class BannerWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitBanner/banner/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Banner')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Banner')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Banner();
        $form = $this->createForm(BannerType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Banner')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Banner')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Banner')]
