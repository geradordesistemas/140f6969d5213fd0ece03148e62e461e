...
use App\Application\Internit\StatusBundle\Form\StatusType;
...
#[Route('/web/status', name: 'web_status_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Status', description: 'Permissões do modulo Status')]
class StatusWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationInternitStatus/status/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Status')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Status')]
    public function createAction(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        $data = new Status();
        $form = $this->createForm(StatusType::class, $data);
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Status')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Status')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Status')]
