...
namespace App\Application\Internit\StatusBundle\Controller;

use App\Application\Internit\StatusBundle\Repository\StatusRepository;
...
#[OA\Tag(name: 'Status')]
#[ACL\Api(enable: true, title: 'Status', description: 'Permissões do modulo Status')]
class StatusApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — Status.
     * Recupera a coleção de recursos — Status.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos Status',
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — Status.
     * Cria o Recurso — Status.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso Status',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar Status')]
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Status')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'Status não encontrado!'], 404);
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Status')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Status')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Status removido com sucesso.'], 204);
    }
