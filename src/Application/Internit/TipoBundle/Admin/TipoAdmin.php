<?php
namespace App\Application\Internit\TipoBundle\Admin;
...
final class TipoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof Tipo ? $object->getId().''
    ...
    protected function configureFormFields(FormMapper $form): void
    {
        $form->tab('Geral');
            $form->with('Informações Gerais');
                ...
                $form->add('descricao',  CheckboxType::class, [
                    'label' => 'Descricao',
                    'required' =>  false ,
