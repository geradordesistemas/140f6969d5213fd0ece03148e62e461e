...
#[ACL\Admin(enable: true, title: 'Tipo', description: 'Permissões modulo Tipo')]
class TipoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Tipo')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Tipo')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Tipo')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Tipo')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Tipo')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Tipo em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Tipo')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Tipo')]
