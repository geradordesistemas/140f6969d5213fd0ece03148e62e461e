...
namespace App\Application\Internit\CorretorOnlineBundle\Controller;

use App\Application\Internit\CorretorOnlineBundle\Repository\CorretorOnlineRepository;
...
#[Route('/api/corretorOnline', name: 'api_corretorOnline_')]
#[OA\Tag(name: 'CorretorOnline')]
#[ACL\Api(enable: true, title: 'CorretorOnline', description: 'Permissões do modulo CorretorOnline')]
class CorretorOnlineApiController extends BaseApiController
{

    public function getClass(): string
    {
        return CorretorOnline::class;
    }
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — CorretorOnline.
     * Recupera a coleção de recursos — CorretorOnline.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos CorretorOnline',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar CorretorOnline')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — CorretorOnline.
     * Cria o Recurso — CorretorOnline.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso CorretorOnline',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar CorretorOnline')]
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera o recurso — CorretorOnline.
     * Recupera o recurso — CorretorOnline.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
        response: 200,
        description: 'Retorna recurso CorretorOnline',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar CorretorOnline')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'CorretorOnline não encontrado!'], 404);
    ...
    /** ****************************************************************************************** */
    /**
     * Substitui o recurso — CorretorOnline.
     * Substitui o recurso — CorretorOnline.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar CorretorOnline')]
    ...
    /** ****************************************************************************************** */
    /**
    * Remove o recurso — CorretorOnline.
    * Remove o recurso — CorretorOnline.
    */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar CorretorOnline')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'CorretorOnline removido com sucesso.'], 204);
    }
