...
return [
    ...
    App\Application\Internit\BannerBundle\ApplicationInternitBannerBundle::class => ['all' => true],
    App\Application\Internit\StatusBundle\ApplicationInternitStatusBundle::class => ['all' => true],
    App\Application\Internit\TagBundle\ApplicationInternitTagBundle::class => ['all' => true],
    App\Application\Internit\CorretorOnlineBundle\ApplicationInternitCorretorOnlineBundle::class => ['all' => true],
    App\Application\Internit\RealizacaoBundle\ApplicationInternitRealizacaoBundle::class => ['all' => true],
    App\Application\Internit\TipoBundle\ApplicationInternitTipoBundle::class => ['all' => true],
